...
### New table. Treatment modalities.
...
data_tbl_assesstype %>%
    ...
    datatable(rownames = FALSE, 
            ...
            options = list(
               ...
               dom = 'Bti',  # https://datatables.net/reference/option/dom
...
Response to G.7 _"The authors may consider presenting the data in the 'Evolution of research and assessment' paragraph using a table instead."_

- This table can substitute the last paragraph of section “Evolution of research and assessment”. 

- To add __"0 (0%)"__ in the cell "Usability/UX" x "PILOT RCT - N (0%)"
...
### Table 1: Mental disorders and the studies targeting them.
