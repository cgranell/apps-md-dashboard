...
# Key facts {.facts data-navmenu="Explore"}
...
```{r}
years <- "2012-2018"
valueBox(years, icon = "fa-calendar-alt", color = "info")
```
...
- To complement figure 3, some percentages are discussed in the body of the article which are included in the table.
